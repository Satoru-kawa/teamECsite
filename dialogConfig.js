		...
		buttons: [
			{
				...
				click: function() {
					...
					$.ajax({
						type: 'POST',
						url: '/angular/auth/resetPassword',
						data: JSON.stringify(jsonString),
						contentType: 'application/json',
						scriptCharset: 'utf-8'
					})
		...
		buttons: [
			{
				...
				click: function() {
					...
					$.ajax({
						type: 'POST',
						url: '/angular/destination/register',
						data: JSON.stringify(jsonString),
						contentType: 'application/json',
						datatype: 'json',
						scriptCharset: 'utf-8'
...
function settlement(destinationId) {
	$.ajax({
		type: 'POST',
		url: '/angular/settlement/complete',
		data: JSON.stringify({'destinationId': destinationId}),
		datatype: 'json',
		contentType: 'application/json',
	})
	.then((result) => {
		location.replace('/angular/history/');
	}, () => {
		alert('Error: ajax connection failed.');
	});
}
